function twitterCallback2(twitters) {
	...
	for (var i = 0; i < twitters.length; i++) {
		...
		statusHTML.push('<p class="twitter-author"><a href="http://twitter.com/' + username + '" target="_blank"><img src="images/twitter.png" alt="" /></a></p><p class="tweet">' + status + '</p><p class="twitter-date">' + relative_time(twitters[i].created_at) + '</p>');
	}
